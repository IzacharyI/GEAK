...
- **Get a concrete GEMM development candidate** → [`../corpus/gemm_decisions.md`](../corpus/gemm_decisions.md):
  conditions, action, alternatives, evidence strength and limits. Follow its citations into
  [`gemm_source_evidence.md`](../corpus/gemm_source_evidence.md) when you need the six-language source
  precedent. `run_recurrence.md` says what paid across measured runs; these cards say what to try next
  and how strongly it is grounded.
...
corpus/       one operator family, six languages, indexed from source at a pinned commit (generated)
